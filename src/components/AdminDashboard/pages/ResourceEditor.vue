<template>
  <div class="reditor" dir="rtl">
    ...
    <!-- Generic helper editor (only for resources without custom editor yet) -->
    <template v-else>
...
// ✅ ALL dedicated editor routes — includes albums now
const customEditorRouteNames = {
  ...
  films:               { create: 'AdminFilmCreate',            edit: 'AdminFilmEdit' },
  ...
  albums:              { create: 'AdminAlbumCreate',           edit: 'AdminAlbumEdit' },
}
