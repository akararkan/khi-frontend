...
const UI_STRINGS = {
  CKB: {
    ...
    contact: {
      ...
      heroSub: 'ئەگەر پرسیارێکت هەیە یان داواکارییەکت هەیە، پەیوەندیمان پێوە بکە',
      infoTitle: 'زانیاری پەیوەندی',
      phone: 'تەلەفۆن',
      email: 'ئیمەیڵ',
      location: 'شوێن',
      workHours: 'کاتی کارکردن',
      workHoursValue: 'یەکشەممە - پێنجشەممە • ٩:٠٠ - ١٦:٠٠',
      mapTitle: 'شوێنی ئێمە لە نەخشەدا',
      formTitle: 'نامەیەک بنێرە',
      formSub: 'نامەکەت لە ماوەی ٢٤-٤٨ کاتژمێردا وەڵام دەدرێتەوە',
      ...
      topicLabel: 'جۆری داواکاری',
      topicGeneral: 'گشتی',
      topicService: 'خزمەتگوزاری',
      topicProject: 'پڕۆژە',
      topicPublication: 'بڵاوکراوە',
      ...
      resetBtn: 'سڕینەوە',
      successTitle: 'سوپاس!',
      successMsg: 'نامەکەت بە سەرکەوتوویی نێردرا. بە زووترین کات وەڵامت دەدەینەوە.',
      sendAnother: 'نامەیەکی تر بنێرە',
      errorName: 'ناو پێویستە',
      errorEmail: 'ئیمەیڵ پێویستە',
      errorEmailInvalid: 'ئیمەیڵ دروست نییە',
      errorSubject: 'بابەت پێویستە',
      errorMessage: 'نامەکەت کەمە (١٠ پیت زیاتر)',
      errorSend: 'هەڵەیەک ڕوویدا. تکایە دووبارە هەوڵبدەرەوە.',
    },

    // Footer
    footer: {
      newsletterTitle: 'بەشداری لە نامەی نوێترینەکان',
      newsletterText: 'نوێترین هەواڵ و چالاکییەکان وەربگرە',
      newsletterPlaceholder: 'ئیمەیڵ...',
      subscribe: 'بەشداربە',
      ...
      ongoing: 'بەردەوام',
      completed: 'تەواوکراو',
      publishmentsTitle: 'بڵاوکراوەکان',
      allPublishments: 'هەموو بڵاوکراوەکان',
      writings: 'نووسین',
      sounds: 'دەنگ',
      videos: 'ڤیدیۆ',
      ...
      language: 'زمان',
      donateTitle: 'پشتگیری ئێمە بکە',
      donateText: 'بە بەخشینی خۆت یارمەتی پاراستنی کەلەپووری کوردی بدە',
      donateBtn: 'بەخشین',
      submitProject: 'ناردنی پڕۆژە',
      requestService: 'داواکاری خزمەتگوزاری',
      contact: 'پەیوەندی',
      home: 'سەرەکی',
      projects: 'پڕۆژەکان',
      publishments: 'بڵاوکراوەکان',
      ...
      locationText: 'سلێمانی، هەرێمی کوردستان',
    },
  },
  ...
  KMR: {
    ...
    contact: {
      heroKicker: 'Têkilî',
      heroTitle: 'Bi me re têkilî daynin',
      heroSub: 'Heke pirsiyareke we heye an daxwaziyeke we heye, bi me re têkilî daynin',
      infoTitle: 'Agahiyên Têkiliyê',
      phone: 'Telefon',
      email: 'E-mail',
      location: 'Cih',
      workHours: 'Demên Karê',
      workHoursValue: 'Yekşem - Pêncşem • 9:00 - 16:00',
      mapTitle: 'Cihê me li nexşeyê',
      formTitle: 'Nameyek bişînin',
      formSub: 'Nameya we di nav 24-48 saetan de tê bersivdan',
      nameLabel: 'Navê tevahî',
      namePlaceholder: 'Navê xwe binivîsin',
      emailLabel: 'E-mail',
      emailPlaceholder: 'name@example.com',
      subjectLabel: 'Mijar',
      subjectPlaceholder: 'Mijara nameya xwe',
      topicLabel: 'Cureyê daxwaziyê',
      topicGeneral: 'Giştî',
      topicService: 'Karûbar',
      topicProject: 'Proje',
      topicPublication: 'Weşan',
      topicPartnership: 'Hevkarî',
      messageLabel: 'Name',
      messagePlaceholder: 'Nameya xwe binivîsin...',
      sendBtn: 'Nameye bişîne',
      sending: 'Şandiye...',
      resetBtn: 'Jêbirin',
      successTitle: 'Spas!',
      successMsg: 'Nameya we bi serkeftî hat şandin. Di demek kurt de bersiva we tê dayîn.',
      sendAnother: 'Nameyek din bişîne',
      errorName: 'Nav pêwîst e',
      errorEmail: 'E-mail pêwîst e',
      errorEmailInvalid: 'E-mail ne rast e',
      errorSubject: 'Mijar pêwîst e',
      errorMessage: 'Nameya we kurt e (ji 10 tîpan zêdetir)',
      errorSend: 'Çewtiyeke pêk hat. Ji kerema xwe dubare biceribîne.',
    },

    // Footer
    footer: {
      newsletterTitle: 'Beşdarî nameya nûçeyan',
      newsletterText: 'Nûçe û çalakiyên herî nû werbigirin',
      newsletterPlaceholder: 'E-mail...',
      subscribe: 'Beşdar bibe',
      socialLabel: 'Têkilî',
      projectsTitle: 'Proje',
      allProjects: 'Hemû Proje',
      ongoing: 'Berdewam',
      completed: 'Qediyayî',
      publishmentsTitle: 'Weşan',
      allPublishments: 'Hemû Weşan',
      writings: 'Nivîsar',
      sounds: 'Deng',
      videos: 'Vîdyo',
      servicesTitle: 'Karûbar',
      allServices: 'Hemû Karûbar',
      studio: 'Studyo',
      print: 'Çap',
      aboutTitle: 'Derbarê',
      aboutUs: 'Derbarê me',
      ...
      language: 'Ziman',
      donateTitle: 'Piştgiriya me bikin',
      donateText: 'Bi bexşandina xwe arîkariya parastina mîrasa Kurdî bikin',
      donateBtn: 'Bexşandin',
      submitProject: 'Projeyê Bişîne',
      requestService: 'Daxwaziya Karûbar',
      contact: 'Têkilî',
      home: 'Sereke',
      projects: 'Proje',
      publishments: 'Weşan',
      ...
      privacy: 'Nepenî',
      terms: 'Şert',
      copyright: 'Hemû maf parastî ne.',
      locationText: 'Silêmanî, Herêma Kurdistanê',
    },
  },
}
